...
verifyConfig () {
	...
	if [ -z "$videoPath" ]; then
		...
		log "Updated your \"/config/extended.conf\" file with the latest options, see: https://gitea.rcs1.top/sickprodigy/arr-scripts/src/branch/main/lidarr/extended.conf"
		log "Sleeping (infinity)"
		sleep infinity
	fi
